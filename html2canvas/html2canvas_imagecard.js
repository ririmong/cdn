    ...
    var CanvasRenderer = /** @class */ (function (_super) {
        ...
        CanvasRenderer.prototype.renderReplacedElement = function (container, curves, image) {
            ...
            if (image && container.intrinsicWidth > 0 && container.intrinsicHeight > 0) {
                ...
                this.drawImage(image, 0, 0, container.intrinsicWidth, container.intrinsicHeight, box.left, box.top, box.width, box.height, container.styles.objectFit, container.styles.objectPosition);
                ...
                //     newWidth = width;
                //     newHeight = height;
                //     this.drawImage(image, 0, 0, container.intrinsicWidth, container.intrinsicHeight, newX + x, newY + y, newWidth, newHeight);
                // } else {
                //     this.drawImage(image, 0, 0, container.intrinsicWidth, container.intrinsicHeight, box.left, box.top, box.width, box.height);
                // }
        ...
        CanvasRenderer.prototype.drawImage = function (image, sx, sy, sw, sh, dx, dy, dw, dh, objectFit, objectPosition) {
            ...
            let horizontalPosition = objectPosition[0].number;
            let verticalPosition = objectPosition[1].number;
            ...
            switch (objectFit) {
                case 'cover':
                    if (sourceRatio > destinationRatio) {
                        ...
                        let rate = horizontalPosition > 0 ? horizontalPosition / 100 : 0;
                        let offsetX = (sw - newSw);
                        ...
                        let rate = verticalPosition > 0 ? verticalPosition / 100 : 0;
                        let offsetY = (sh - newSh);
